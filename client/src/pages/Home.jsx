...
export default function Home() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12 sm:py-20 animate-fade-in">
      <div className="flex flex-col md:flex-row items-center gap-12 md:gap-16">
        {/* Text */}
        <div className="flex-1 text-center md:text-left space-y-6">
          <div>
            <span className="inline-block px-3 py-1 bg-green-500/10 border border-green-500/30 text-green-400 text-xs font-medium rounded-full mb-4">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-[3.5rem] font-extrabold leading-[1.1] tracking-tight">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-blue-400 to-purple-400">Shaik Mahammad Tarik</span>
            </h1>
          </div>
          ...
          <div className="flex flex-wrap gap-3 justify-center md:justify-start pt-2">
            <Link to="/projects" className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-cyan-500 to-blue-600 text-white font-semibold rounded-xl hover:scale-105 hover:shadow-xl hover:shadow-cyan-500/25 transition-all duration-200 text-sm">
              View Projects <FaArrowRight className="text-xs" />
            </Link>
            <Link to="/contact" className="inline-flex items-center gap-2 px-6 py-3 bg-white/5 border border-cyan-500/25 text-cyan-400 font-semibold rounded-xl hover:bg-cyan-500/10 hover:border-cyan-500/40 transition-all duration-200 text-sm">
              Contact Me
            </Link>
            <a href="/Resume.pdf" target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 px-6 py-3 bg-white/5 border border-gray-600/30 text-gray-300 font-semibold rounded-xl hover:bg-white/10 transition-all duration-200 text-sm">
              Resume
            </a>
          </div>
        </div>
        ...
        <div className="flex-shrink-0 relative">
          <div className="absolute inset-0 bg-gradient-to-br from-cyan-500/20 to-blue-600/10 rounded-full blur-3xl scale-125 animate-pulse"></div>
      ...
      <div className="grid grid-cols-3 gap-4 mt-20 max-w-2xl mx-auto">
        {[
          ...
          <div key={i} className="text-center py-4 px-3 bg-[#0d1f3c]/50 border border-cyan-500/10 rounded-xl hover:border-cyan-500/25 transition-colors">
